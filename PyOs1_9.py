...
sys.update.list - list of all updates
sys.update.check - check new updates
''')
		exit = input('''----------
Enter to exit''')
		clear()
...
Enter to exit''')
		clear()
	elif command == 'sys.update.check':
		clear()
		#Мб парсер с моего сайта накатить в некст обнове
		print('No updates found.')
		exit = input('''----------
Enter to exit''')
		clear()
	elif command == 'sys.update.list':\		clear()
		print('''PyOs v1.9
-bugfixes
-new commands
